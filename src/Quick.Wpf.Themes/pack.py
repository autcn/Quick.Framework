...
parser.add_argument('-Version','--Version', default='1.0.5-beta.4')
parser.add_argument('-CoreVersion','--CoreVersion', default='1.0.4-beta.4')
...
ProjectName = 'Quick.Wpf.Themes'
PackageId = 'QuickFramework.Wpf.Themes'
