...
namespace MultiLanguageDemo
{
    ...
    public class AppModule : QModule
    {
        ...
        {
            /*说明:(1)语言文件必须放在Localization目录下，每个Culture建立一个子目录
             *    (2) 在Xaml中使用 {DynamicResource App.MainWindow.Title}来指定多语言
             *    (3)在C#代码中注入ILocalization服务，调用GetResString()函数来获取多语言字符串
             */
